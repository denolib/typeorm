...
describe("uuid-mysql", () => {
    ...
    test("should set generated uuid in the model after save", () => Promise.all(connections.map(async connection => {
        const question = new Question();
        question.uuid2 = "fd357b8f-8838-42f6-b7a2-ae027444e895";
        await connection.manager.save(question);
        expect(question!.id).toBeDefined();
        expect(question!.uuid).toBeDefined();
        expect(question!.uuid2).toBeDefined();
    })));
