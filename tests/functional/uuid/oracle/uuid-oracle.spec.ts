...
describe("uuid-oracle", () => {
    ...
    test("should persist uuid correctly when it is generated non primary column", () => Promise.all(connections.map(async connection => {
        ...
        expect(postTable!.findColumnByName("uuid")!.type).toEqual("varchar2");
        ...
        expect(questionTable!.findColumnByName("id")!.type).toEqual("varchar2");
        expect(questionTable!.findColumnByName("uuid")!.type).toEqual("varchar2");
        expect(questionTable!.findColumnByName("uuid2")!.type).toEqual("varchar2");
        expect(questionTable!.findColumnByName("uuid3")!.type).toEqual("varchar2");
