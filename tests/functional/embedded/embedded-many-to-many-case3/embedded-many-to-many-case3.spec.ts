...
describe("embedded > embedded-many-to-many-case3", () => {
    ...
    describe("owner side", () => {
        ...
        test("should insert, load, update and remove entities with embeddeds when embedded entity having ManyToMany relation with multiple primary keys (one PK in each embed)", () => Promise.all(connections.map(async connection => {
